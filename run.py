...
TOKEN = "5007713837:AAFAFF-zyIN7XTf_AgM3A-tdKUk6qvfdg60"
TELEGRAM_USER = "Aashath"

# Heroku Credentials
APP_URL = "https://mt4tradingbot-ojwc.onrender.com/"
...
def GetTradeInformation(update: Update, trade: dict, balance: float) -> None:
    ...
    if float(format(balance)) < 200:
        trade['PositionSize'] = float(0.01)
    else:     
        trade['PositionSize'] = float(format(balance))/2/10000
